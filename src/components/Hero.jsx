...
const Hero = () => {
  ...
  const handleModalSubmit = async (name, phone) => {
    await trackLead(name, phone, selectedBranch, 'hero_book_trial')
    
    const message = `Hi! I'm interested in booking a free trial at Adiyash Gym`
  ...
  return (
    <>
      <section className="relative h-screen max-h-[700px] flex items-center justify-center overflow-hidden pt-16 md:pt-20 pb-20">
        {/* Background Video */}
        <video
          autoPlay
          loop
