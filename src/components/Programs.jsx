      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {siteConfig.programs.map((program) => (
            <div key={program.id} className="bg-white border border-ink/10 rounded-lg p-6 hover:border-purple/50 transition-all hover:scale-[1.02] shadow-sm text-center">
